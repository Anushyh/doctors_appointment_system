...
-- Dumping data for table `medical_specialty`
--
INSERT INTO `patient_list` (`id`,`name`,`address`,`contact_no`,`date_created`) VALUES 
(7,'George Wilson','Sample Clinic Address','+1456 554 55623','2020-09-24 15:20:52');
-- --------------------------------------------------------
...
--
ALTER TABLE `appointment_list`
 ADD CONSTRAINT `appointment_list_ibfk_1` FOREIGN KEY (`doctor_id`) REFERENCES `doctors_list` (`id`) ON DELETE CASCADE;
 
--
-- constraints for table `doctors_schedule`
--
ALTER TABLE `doctors_schedule`
ADD CONSTRAINT `doctors_schedule_ibfk_2` FOREIGN KEY (`doctor_id`) REFERENCES `doctors_list` (`id`) ON DELETE CASCADE;
